    ...
    public partial class UCBaoCao : UserControl
    {
        ...
        private void LoadBaoCaoNoDocGia()
        {
            try
            {
                ...
                // Cập nhật label để biết đang xem báo cáo nào
                label1.Text = $"Báo cáo nợ độc giả ({list.Count} độc giả)";
                ...
                if (dgvQuaHan.Columns["MaPhieuMuon"] != null)
                    dgvQuaHan.Columns["MaPhieuMuon"].Visible = false;
                if (dgvQuaHan.Columns["NgayMuon"] != null)
                    dgvQuaHan.Columns["NgayMuon"].Visible = false;
        ...
        private void LoadBaoCaoQuaHan()
        {
            try
            {
                ...
                {
                    dgvQuaHan.Columns["MaDocGia"].HeaderText = "Mã độc giả";
                    dgvQuaHan.Columns["MaDocGia"].Visible = true;
                }

                if (dgvQuaHan.Columns["HoTen"] != null)
                {
                    dgvQuaHan.Columns["HoTen"].HeaderText = "Họ tên";
                    dgvQuaHan.Columns["HoTen"].Visible = true;
                }

                if (dgvQuaHan.Columns["MaPhieuMuon"] != null)
                {
                    dgvQuaHan.Columns["MaPhieuMuon"].HeaderText = "Mã phiếu";
                    dgvQuaHan.Columns["MaPhieuMuon"].Visible = true;
                }
                ...
                if (dgvQuaHan.Columns["NgayMuon"] != null)
                {
                    ...
                    dgvQuaHan.Columns["NgayMuon"].Visible = true;
                }
                ...
                if (dgvQuaHan.Columns["TienPhat"] != null)
                {
                    ...
                    dgvQuaHan.Columns["TienPhat"].Visible = true;
                }

                // Ẩn các cột của báo cáo nợ độc giả
                if (dgvQuaHan.Columns["NoHienTai"] != null)
                    dgvQuaHan.Columns["NoHienTai"].Visible = false;
                if (dgvQuaHan.Columns["SoSachQuaHan"] != null)
                    dgvQuaHan.Columns["SoSachQuaHan"].Visible = false;
                if (dgvQuaHan.Columns["TongNoUocTinh"] != null)
                    dgvQuaHan.Columns["TongNoUocTinh"].Visible = false;
